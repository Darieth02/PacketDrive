...
header("Access-Control-Allow-Headers: Content-Type");
	...
	$contraseña = mysqli_real_escape_string($conexion,$_POST['contraseña']);  //usamos este método php para evitar inyección sql a la bd
		...
		$select = "SELECT * FROM packetdrive.user WHERE correo='$correo'";
		...
		if(mysqli_num_rows($res_Select) == 0){
			...
			$insertar = "INSERT INTO packetdrive.user (nombre,apellidos,edad,correo, contraseña,tipo_usuario) VALUES('$nombre','$apellidos','$edad','$correo','$contraseña','usuario')";
